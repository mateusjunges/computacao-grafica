package viewparallelprojection;
...
//*** and its transformation group.               ***
    ...
    Box platform = new Box(platformSize,platformSize,platformSize,yellowApp);
...
//*** The cockpit of the helicopter. ****
    ...
    setToMyDefaultAppearance(pinkApp,new Color3f(1.0f,0.0f,0.7f));

    //Radius of the cockpit.
    float cabinRadius = 0.1f;

    //Generate the cockpit in the form of a sphere.
    Sphere cabin = new Sphere(cabinRadius,pinkApp);
...
//*** The rotor blade of the helicopter. ***
    ...
    Box rotor = new Box(0.4f,0.0001f,0.01f,redApp);
...
//*** The tail of the helicopter. ***
    ...
    Box tail = new Box(halfTailLength,0.02f,0.02f,pinkApp);
...
//*** The treetop. ***
    ...
    Cone leaves = new Cone(0.3f,leavesHeight,pinkApp);
